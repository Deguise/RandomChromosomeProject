...
sub fimo_installation {
	...
	system "wget http://meme-suite.org/meme-software/5.0.1/meme_5.0.1.tar.gz";
...
sub fimo_database {
	...
	system "wget -P Database/ http://hocomoco11.autosome.ru/final_bundle/hocomoco11/core/HUMAN/mono/HOCOMOCOv11_core_HUMAN_mono_meme_format.meme";
